...
Read `../_shared/venom-context.md` first.
    ...
    2. Reuse existing project tokens (`--venom-*`, semantic `--*` tokens, and established variables).
    ...
    7. Validate `ocean` and one contrasting accent (`emerald`, `crimson`, `amber`, or `violet`) after a theme-affecting change.
