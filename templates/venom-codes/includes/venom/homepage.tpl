<div id="venomHomepage" class="venom-homepage" data-venom-page="home">
    <div class="venom-floating-controls" role="region" aria-label="Theme Controls">
        <button id="venomThemeToggle" class="venom-toggle-btn" type="button" aria-label="Toggle theme">
            <span class="venom-toggle-btn__label">Dark Theme</span>
        </button>
        <div class="venom-accent-picker" role="group" aria-label="Accent Colors">
            <button type="button" class="venom-accent-dot is-active" data-accent="ocean" aria-label="Ocean Accent"></button>
            <button type="button" class="venom-accent-dot" data-accent="emerald" aria-label="Emerald Accent"></button>
            <button type="button" class="venom-accent-dot" data-accent="crimson" aria-label="Crimson Accent"></button>
            <button type="button" class="venom-accent-dot" data-accent="amber" aria-label="Amber Accent"></button>
            <button type="button" class="venom-accent-dot" data-accent="violet" aria-label="Violet Accent"></button>
        </div>
    </div>
